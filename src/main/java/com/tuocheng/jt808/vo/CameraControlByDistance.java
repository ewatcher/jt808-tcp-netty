 ...
 * ==================================
 */
public class CameraControlByDistance {

    /**
     * bit[0] 摄像通道 1 定距拍照开关标志 0:不允许; 1:允许
     */
    private boolean chanel1CameraFlag;

    /**
     * bit[1] 摄像通道 2 定距拍照开关标志 0:不允许; 1:允许
     */
    private boolean chanel2CameraFlag;

    /**
     * bit[2] 摄像通道 3 定距拍照开关标志 0:不允许; 1:允许
     */
    private boolean chanel3CameraFlag;

    /**
     * bit[3] 摄像通道 4 定距拍照开关标志 0:不允许; 1:允许
     */
    private boolean chanel4CameraFlag;

    /**
     * bit[4] 摄像通道 5 定距拍照开关标志 0:不允许; 1:允许
     */
    ...
    /**
     * bit[8]  摄像通道 1 定距拍照存储标志  0:存储; 1:上传
     */
    private boolean chanel1CameraStoreFlag;

    /**
     * bit[9]  摄像通道 2 定距拍照存储标志  0:存储; 1:上传
     */
    private boolean chanel2CameraStoreFlag;

    /**
     * bit[10]  摄像通道 3 定距拍照存储标志  0:存储; 1:上传
     */
    private boolean chanel3CameraStoreFlag;

    /**
     * bit[11]  摄像通道 4 定距拍照存储标志  0:存储; 1:上传
     */
    private boolean chanel4CameraStoreFlag;

    /**
     * bit[12]  摄像通道 5 定距拍照存储标志  0:存储; 1:上传
     */
    ...
    /**
     * bit[16]  定距距离单位 0:米,当数值小于 100 米时,终端按 100 米处理; 1:公里。
     */
    private boolean regularDistanceUnit;

    /**
     * bit[17-31]   定距距离间隔
     */
    private int regularDistanceBeat;
    ...
    public boolean isRegularDistanceUnit() {
        return regularDistanceUnit;
    }

    public void setRegularDistanceUnit(boolean regularDistanceUnit) {
        this.regularDistanceUnit = regularDistanceUnit;
    }

    public int getRegularDistanceBeat() {
        return regularDistanceBeat;
    }

    public void setRegularDistanceBeat(int regularDistanceBeat) {
        this.regularDistanceBeat = regularDistanceBeat;
    }

    @Override
    public String toString() {
        return "CameraControlByDistance{" +
                ...
                ", regularDistanceUnit=" + regularDistanceUnit +
                ", regularDistanceBeat=" + regularDistanceBeat +
                '}';
    }
}
